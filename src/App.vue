...
<template>
    <div class="fixed w-full h-screen bg-black">
      <div
        ...
        "
      >
      <img class="absolute top-10 w-[35px] mt-10 ml-10" src="/images/netflix-logo.png" alt="넷플릭스 로고">
      <div>
        <div
          class="py-2 mx-10 my-6"
        >
          <Magnify fillColor="#fff" :size="40" class="cursor-pointer"/>
        </div>
        <div
          class="py-2 mx-10 my-6 border-b-4 border-b-red-500"
        >
    ...
    <div v-if="!showFullVideo">
      <div class="fixed flex z-20 top-0 right-0 w-full h-[50%] bg-black pl-[120px] bg-clip-border">
        ...
        <video
          ...
          autoplay
          loop
          class="absolute z-10 h-[600px] right-0 top-0"
        />
      </div>
