<template>
  <div class="page-content">
    ...
    <div class="carousel-container" :style="{ left: navWidth }">
      <VideoCarousel class="carousel-section" category="Trending Movies" :movies="movies[0]"/>
      <VideoCarousel class="carousel-section" category="Popular Movies" :movies="movies[1]"/>
