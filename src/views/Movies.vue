<template>
  <div class="page-content">
    ...
    <div class="carousel-container" :style="{ left: navWidth }">
      <VideoCarousel class="carousel-section" category="New Movies" :movies="movies[0]"/>
      <VideoCarousel class="carousel-section" category="Action Movies" :movies="movies[1]"/>
      <VideoCarousel class="carousel-section last" category="Comedy Movies" :movies="movies[2]"/>
    </div>
  </div>
</template>
